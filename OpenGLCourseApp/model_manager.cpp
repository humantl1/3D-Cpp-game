...
void ModelManager::LoadModel(const std::string& fileName)
{
	...
	const aiScene* scene = importer.ReadFile(fileName,
												aiProcess_Triangulate |		// will split complex shapes into triangles, if necessary
...
void ModelManager::LoadNode(aiNode* node, const aiScene* scene)
{
...
void ModelManager::LoadMesh(aiMesh* mesh, const aiScene* scene)
{
...
void ModelManager::LoadMaterials(const aiScene* scene)
{
